...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Mateo's Blog</h1>", unsafe_allow_html=True)
    ...
    texto = """
    ¡Hola! mi nombre es Mateo Angeles, vine de Cusco a Lima para continuar mis estudios supériores, 
    actualmente en catolica estudio la carrera de Comunicación para el Desarrollo. Hasta ahora he disfrutado 
    bastante de mis clases y experiencias. Me gusta mucho escribir y dar información asi como compartir mis
    puntos de vista con los demas, me agrada saber que estoy construyendo conocimientos que me permitiran ayudar 
   ...
   aprender a desarrollar videojuegos simples, siento que seria un proyecto interesante, distinto y divertido.
    ...
    st.markdown("<h2 style='text-align: center;'>Mis primeros pasos en la programación</h2>", unsafe_allow_html=True)
    ...
    st.video("https://youtu.be/3kwImz76Xs0")
